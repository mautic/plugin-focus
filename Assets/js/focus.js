...
Mautic.launchFocusBuilder = function (forceFetch) {
    ...
    if (!mQuery('#builder-overlay').length) {
        ...
        var overlay = mQuery('<div id="builder-overlay" class="modal-backdrop fade in"><div style="position: absolute; top:50%; left:' + spinnerLeft + 'px"><i class="ri-loader-3-line ri-spin fa-5x"></i></div></div>').css(builderCss).appendTo('.builder-content');
    }
